...
class Ui_Generate_Twiss(object):
    def setupUi(self, Generate_Twiss):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 431, 611))
        ...
        self.zstddev = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.zstddev.setEnabled(False)
        self.zstddev.setObjectName("zstddev")
        self.gridLayout.addWidget(self.zstddev, 8, 2, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.yb, 6, 2, 1, 1, QtCore.Qt.AlignHCenter)
        spacerItem2 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem2, 5, 0, 2, 1)
        self.ye = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.ye.setObjectName("ye")
        self.gridLayout_2.addWidget(self.ye, 7, 2, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_2.addWidget(self.label_5, 7, 1, 1, 1, QtCore.Qt.AlignRight)
        self.bl_label_3 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.bl_label_3.setObjectName("bl_label_3")
        self.gridLayout_2.addWidget(self.bl_label_3, 6, 1, 1, 1, QtCore.Qt.AlignRight)
        self.tr_label_2 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.tr_label_2.setObjectName("tr_label_2")
        self.gridLayout_2.addWidget(self.tr_label_2, 4, 1, 1, 1, QtCore.Qt.AlignLeft)
        self.ya = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.ya.setEnabled(True)
        self.ya.setObjectName("ya")
        self.gridLayout_2.addWidget(self.ya, 5, 2, 1, 1, QtCore.Qt.AlignHCenter)
        self.bl_label_4 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.bl_label_4.setObjectName("bl_label_4")
        self.gridLayout_2.addWidget(self.bl_label_4, 5, 1, 1, 1, QtCore.Qt.AlignRight)
        self.label_6 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_6.setObjectName("label_6")
        self.gridLayout_2.addWidget(self.label_6, 8, 1, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        self.xystddev = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.xystddev.setEnabled(False)
        self.xystddev.setObjectName("xystddev")
        self.gridLayout_2.addWidget(self.xystddev, 8, 2, 1, 1, QtCore.Qt.AlignHCenter)
