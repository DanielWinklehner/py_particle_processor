...
# Form implementation generated from reading ui file 'plot_properties_window.ui'
#
...
class Ui_PlotPropertiesWindow(object):
    def setupUi(self, PlotPropertiesWindow):
        PlotPropertiesWindow.setObjectName("PlotPropertiesWindow")
        PlotPropertiesWindow.resize(377, 251)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(PlotPropertiesWindow.sizePolicy().hasHeightForWidth())
        PlotPropertiesWindow.setSizePolicy(sizePolicy)
        self.centralwidget = QtWidgets.QWidget(PlotPropertiesWindow)
        ...
        PlotPropertiesWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(PlotPropertiesWindow)
        ...
        QtCore.QMetaObject.connectSlotsByName(PlotPropertiesWindow)

    def retranslateUi(self, PlotPropertiesWindow):
        _translate = QtCore.QCoreApplication.translate
        PlotPropertiesWindow.setWindowTitle(_translate("PlotPropertiesWindow", "Properties"))
        self.dataset_label.setText(_translate("PlotPropertiesWindow", "Plot Settings (X-X)"))
        self.bl_enabled.setText(_translate("PlotPropertiesWindow", "Enabled"))
        self.tl_combo_a.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.tl_combo_a.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.tl_combo_a.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.tl_combo_a.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.tl_combo_a.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.tl_combo_a.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.bl_combo_a.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.bl_combo_a.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.bl_combo_a.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.bl_combo_a.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.bl_combo_a.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.bl_combo_a.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.tl_enabled.setText(_translate("PlotPropertiesWindow", "Enabled"))
        self.tl_label.setText(_translate("PlotPropertiesWindow", "Top Left:"))
        self.tr_label.setText(_translate("PlotPropertiesWindow", "Top Right:"))
        self.step_label.setText(_translate("PlotPropertiesWindow", "Step #:"))
        self.tr_combo_b.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.tr_combo_b.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.tr_combo_b.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.tr_combo_b.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.tr_combo_b.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.tr_combo_b.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.bl_combo_b.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.bl_combo_b.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.bl_combo_b.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.bl_combo_b.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.bl_combo_b.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.bl_combo_b.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.three_d_enabled.setText(_translate("PlotPropertiesWindow", "Enabled"))
        self.tr_combo_a.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.tr_combo_a.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.tr_combo_a.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.tr_combo_a.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.tr_combo_a.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.tr_combo_a.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.tl_combo_b.setItemText(0, _translate("PlotPropertiesWindow", "X"))
        self.tl_combo_b.setItemText(1, _translate("PlotPropertiesWindow", "Y"))
        self.tl_combo_b.setItemText(2, _translate("PlotPropertiesWindow", "Z"))
        self.tl_combo_b.setItemText(3, _translate("PlotPropertiesWindow", "PX"))
        self.tl_combo_b.setItemText(4, _translate("PlotPropertiesWindow", "PY"))
        self.tl_combo_b.setItemText(5, _translate("PlotPropertiesWindow", "PZ"))
        self.bl_label.setText(_translate("PlotPropertiesWindow", "Bottom Left:"))
        self.three_d_label.setText(_translate("PlotPropertiesWindow", "3D Plot:"))
        self.tr_enabled.setText(_translate("PlotPropertiesWindow", "Enabled"))
        self.redraw_label.setText(_translate("PlotPropertiesWindow", "Redraw On Selection: "))
        self.redraw_enabled.setText(_translate("PlotPropertiesWindow", "Enabled"))
        self.redraw_button.setText(_translate("PlotPropertiesWindow", "Redraw Plots"))
        self.cancel_button.setText(_translate("PlotPropertiesWindow", "Cancel"))
        self.apply_button.setText(_translate("PlotPropertiesWindow", "Apply"))
